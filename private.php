...
<head>
    ...
    <title>PRIVATE | N8Plus Future Coffee Shop</title>
                    ...
                    <div class="tab_container">
                        <div class="tab_content" id="tab1">
                            <form method="POST" action="login.php">
                                ...
                                <button type="submit" name="login" value="private.php">Login</button>
                            </form>
        ...
        <div class="container">
            <div class="service-detail clearfix">
                ...
                <div class="service-des">
                    <h2>Description:</h2>
                    <p>When you use this mode, your table will be surrounded by walls of glasses which prevented sound, no one can see inside. A perfect mode if you want to do something in private.</p>
                </div>
                <hr>
