...
?>
    ...
    <head>
        ...
        <title>BOOK-PARTY | N8Plus Future Coffee Shop</title>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="book-party.php">Login</button>
                                </form>
                        ...
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                <div class="booked-info">
                                    Table: <b>PT01</b><br>Date: <b>November 19th, 2017</b><br>Time: <b>18:00</b><br>
                                </div>
...
<option value="book-party.php" selected>Party</option>
<option value="book-kid.php">For Kid</option>
                        ...
                        <div class="collapse navbar-collapse " id="bs-sidebar-navbar-collapse-1 ">
                            <ul class="nav navbar-nav ">
                                ...
                                <li class="active"><a href="#">Party<span style="font-size:20px; " class="pull-right hidden-xs showopacity glyphicon glyphicon-glass "></span></a></li>
                ...
                <div class="main-content">
                    <div class="row note ">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon choice" src="image/table/PT01.PNG">
                            <div class="note-text "><b>Your choice</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon " src="image/table/PT01.PNG ">
                            <div class="note-text "><b>Empty table</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon booked" src="image/table/PT01.PNG">
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT01.PNG">
                                <div class="table-name ">PT01</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT01.PNG">
                                <div class="table-name ">PT02</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/PT01.PNG">
                                <div class=" table-name ">PT03</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/PT01.PNG">
                                <div class=" table-name ">PT04</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT01.PNG ">
                                <div class="table-name ">PT05</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/PT01.PNG ">
                                <div class="table-name ">PT06</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT01.PNG ">
                                <div class="table-name ">PT07</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT01.PNG ">
                                <div class="table-name ">PT08</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/PT02.PNG ">
                                <div class="table-name ">PT09</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT10</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT11</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT12</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT13</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/PT02.PNG ">
                                <div class="table-name ">PT14</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT15</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/PT02.PNG ">
                                <div class="table-name ">PT16</div>
                            </div>
                        </div>
                    </div>
                    <hr>
