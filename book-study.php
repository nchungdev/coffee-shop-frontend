...
?>
    ...
    <head>
        ...
        <title>BOOK-STUDY | N8Plus Future Coffee Shop</title>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="book-study.php">Login</button>
                                </form>
                        ...
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                <div class="booked-info">
                                    Table: <b>SD01</b><br>Date: <b>November 19th, 2017</b><br>Time: <b>18:00</b><br>
                                </div>
...
<option value="book-study.php" selected>Study</option>
...
<option value="book-kid.php">For Kid</option>
                        ...
                        <div class="collapse navbar-collapse " id="bs-sidebar-navbar-collapse-1 ">
                            <ul class="nav navbar-nav ">
                                ...
                                <li class="active"><a href="#">Study<span style="font-size:20px; " class="pull-right hidden-xs showopacity glyphicon glyphicon-book "></span></a></li>
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                ...
                                <div class="table-name ">SD01</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png">
                                <div class="table-name ">SD02</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/RL01.png">
                                <div class=" table-name ">SD03</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/RL01.png">
                                <div class=" table-name ">SD04</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD05</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/RL01.png ">
                                <div class="table-name ">SD06</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD07</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD08</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/RL01.png ">
                                <div class="table-name ">SD09</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD10</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD11</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD12</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD13</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/RL01.png ">
                                <div class="table-name ">SD14</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD15</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/RL01.png ">
                                <div class="table-name ">SD16</div>
                            </div>
                        </div>
                    </div>
                    <hr>
