    ...
    $('.resCarousel').each(function (index) {
        ...
        for (var i = 0; i < 5; i++) {
            if (i == 0) {
                ...
                var styleCollector4 = ".ResSlid" + index + " .item {width: " + 100 / itemsSplit[i] + "%}";
            }
        }
        ...
        var styleCollector = "@media (max-width:567px){" + styleCollector0 + "}" +
            "@media (min-width:568px){" + styleCollector1 + "}" +
            "@media (min-width:768px){" + styleCollector2 + "}" +
            "@media (min-width:992px){" + styleCollector3 + "}" +
            "@media (min-width:1200px){" + styleCollector4 + "}";
