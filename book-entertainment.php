...
?>
    ...
    <head>
        ...
        <title>BOOK-ENTERTAINMENT | N8Plus Future Coffee Shop</title>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="book-entertainment.php">Login</button>
                                </form>
                        ...
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                <div class="booked-info">
                                    Table: <b>ET01</b><br>Date: <b>November 19th, 2017</b><br>Time: <b>18:00</b><br>
                                </div>
...
<option value="book-relax.php">Relax</option>
<option value="book-study.php">Study</option>
<option value="book-entertainment.php" selected>Entertainment</option>
...
<option value="book-kid.php">For Kid</option>
                        ...
                        <div class="collapse navbar-collapse " id="bs-sidebar-navbar-collapse-1 ">
                            <ul class="nav navbar-nav ">
                                ...
                                <li><a href="book-relax.php">Relax<span style="font-size:20px; " class="pull-right hidden-xs showopacity glyphicon glyphicon-music "></span></a></li>
                                ...
                                <li class="active"><a href="#">Entertainment<span style="font-size:20px; " class="pull-right hidden-xs showopacity glyphicon glyphicon-film "></span></a></li>
                ...
                <div class="wellcome ">
                    <br><br>
                    <h2>Have fun with your friends!</h2>
                    <h4>Choose position: </h4><br>
                </div>
                <div class="main-content">
                    <div class="row note ">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon choice" src="image/table/ET01.png">
                            <div class="note-text "><b>Your choice</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon " src="image/table/ET01.png">
                            <div class="note-text "><b>Empty table</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon booked" src="image/table/ET01.png">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/TV.png">
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET01.png">
                                <div class="table-name ">ET01</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET01.png">
                                <div class="table-name ">ET02</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/ET01.png">
                                <div class=" table-name ">ET03</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/ET01.png">
                                <div class=" table-name ">ET04</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET02.png">
                                <div class="table-name ">ET05</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/ET02.png">
                                <div class="table-name ">ET06</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET02.png">
                                <div class="table-name ">ET07</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET02.png">
                                <div class="table-name ">ET08</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/ET03.png">
                                <div class="table-name ">ET09</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET03.png">
                                <div class="table-name ">ET10</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET03.png">
                                <div class="table-name ">ET11</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET03.png">
                                <div class="table-name ">ET12</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET04.png">
                                <div class="table-name ">ET13</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/ET04.png">
                                <div class="table-name ">ET14</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET04.png">
                                <div class="table-name ">ET15</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/ET04.png">
                                <div class="table-name ">ET16</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
