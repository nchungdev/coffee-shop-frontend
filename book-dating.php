...
?>
    ...
    <head>
        ...
        <title>BOOK-DATING | N8Plus Future Coffee Shop</title>
...
<option value="book-dating.php" selected>Dating</option>
                ...
                <div class="main-content">
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/dating1.png ">
                                <div class="table-name ">DT13</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/dating5.png ">
                                <div class="table-name ">DT14</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/dating5.png ">
                                <div class="table-name ">DT15</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/dating5.png ">
                                <div class="table-name ">DT16</div>
                            </div>
                        </div>
                    </div>
                    <hr>
