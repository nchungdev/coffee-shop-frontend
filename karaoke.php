...
?>
    ...
    <head>
        ...
        <title>KARAOKE | N8Plus Future Coffee Shop</title>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="karaoke.php">Login</button>
                                </form>
            ...
            <div class="container">
                <div class="service-detail clearfix">
                    ...
                    <div class="service-des">
                        <h2>Description:</h2>
                        <p>When you use this mode, your table will be surrounded by walls of glasses which prevented sound. Next, we will give you 2 micro by conveyor. After that, you can sing any song you like.</p>
                    </div>
                    <hr>
