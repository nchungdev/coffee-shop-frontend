...
?>
    ...
    <head>
        ...
        <title>BOOK-KID | N8Plus Future Coffee Shop</title>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="book-kid.php">Login</button>
                                </form>
                        ...
                        <div class="modal-content clearfix">
                            ...
                            <div class="modal-body">
                                <div class="booked-info">
                                    Table: <b>FK01</b><br>Date: <b>November 19th, 2017</b><br>Time: <b>18:00</b><br>
                                </div>
...
<option value="book-kid.php" selected>For Kid</option>
                        </select>
                        </div>
                        <div class="collapse navbar-collapse " id="bs-sidebar-navbar-collapse-1 ">
                            <ul class="nav navbar-nav ">
                                ...
                                <li class="active"><a href="#">For Kid<span style="font-size:20px; " class="pull-right hidden-xs showopacity glyphicon glyphicon-gift "></span></a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                ...
                <div class="wellcome ">
                    <br><br>
                    <h2>Don't worry about your children!</h2>
                ...
                <div class="main-content">
                    <div class="row note ">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon choice" src="image/table/FK01.png">
                            <div class="note-text "><b>Your choice</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon " src="image/table/FK01.png">
                            <div class="note-text "><b>Empty table</b></div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 note-div ">
                            <img class="note-icon booked" src="image/table/FK01.png">
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK01.png">
                                <div class="table-name ">FK01</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK01.png">
                                <div class="table-name ">FK02</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/FK01.png">
                                <div class=" table-name ">FK03</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/FK01.png">
                                <div class=" table-name ">FK04</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK04.png">
                                <div class="table-name ">FK05</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK02.png">
                                <div class="table-name ">FK06</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">
                            <div class="div-pic-table ">
                                <img class="pic-table" src="image/table/FK04.png">
                                <div class="table-name ">FK07</div>
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/Toy.png">
                            </div>
                        </div>
                        <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK02.png">
                                <div class="table-name ">FK08</div>
                            </div>
                        </div>
                    </div>
                    <div class="row ">
                    ...
                    <div class="row ">
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK03.png">
                                <div class="table-name ">FK11</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table booked" src="image/table/FK03.png">
                                <div class="table-name ">FK12</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK03.png">
                                <div class="table-name ">FK13</div>
                            </div>
                        </div>
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 ">
                            <div class="div-pic-table ">
                                <img class="pic-table " src="image/table/FK03.png">
                                <div class="table-name ">FK14</div>
                            </div>
                        </div>
                    </div>
                    <hr>
