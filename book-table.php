...
?>
    ...
    <head>
        ...
        <title>BOOK-TABLE | N8Plus Future Coffee Shop</title>
    ...
    <body>
                        ...
                        <div class="tab_container">
                            <div class="tab_content" id="tab1">
                                <form method="POST" action="login.php">
                                    ...
                                    <button type="submit" name="login" value="book-table.php">Login</button>
                                </form>
        ...
        <section class="body-content">
            <div class="container">
                <br>
                <div class="wellcome"> <b>Choose space: </b></div>
                <br>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/relax.png" alt="Relax">
                            <b class="title">Relax</b>
                        </div>
                        <div class="link">
                            <a href="book-relax.php"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/learn.png" alt="Study">
                            <b class="title">Study</b>
                        </div>
                        <div class="link">
                            <a href="book-study.php"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/entertainment.png" alt="Entertainment">
                            <b class="title">Entertainment</b>
                        </div>
                        <div class="link">
                            <a href="book-entertainment.php"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/dating.png" alt="Dating">
                            <b class="title">Dating</b>
                        </div>
                        <div class="link">
                            <a href="book-dating.php"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/party.png" alt="Party">
                            <b class="title">Party</b>
                        </div>
                        <div class="link">
                            <a href="book-party.php"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-6 col-md-4">
                    <div class="frame">
                        <div class="div-pic">
                            <img class="pic" src="image/kid.png" alt="For Kid">
                            <b class="title">For Kid</b>
                        </div>
                        <div class="link">
                            <a href="book-kid.php"></a>
                        </div>
                    </div>
                </div>
            </div>
